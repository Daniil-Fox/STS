...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_map_js__WEBPACK_IMPORTED_MODULE_2__]);
_components_map_js__WEBPACK_IMPORTED_MODULE_2__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
__webpack_require__.a(__webpack_module__, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _yandex_ymaps3_default_ui_theme__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @yandex/ymaps3-default-ui-theme */ "./node_modules/@yandex/ymaps3-default-ui-theme/dist/esm/index.mjs");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_yandex_ymaps3_default_ui_theme__WEBPACK_IMPORTED_MODULE_0__]);
_yandex_ymaps3_default_ui_theme__WEBPACK_IMPORTED_MODULE_0__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
if (mapContainer) {
  ...
  async function initMap() {
    ...
    map.addChild(new _yandex_ymaps3_default_ui_theme__WEBPACK_IMPORTED_MODULE_0__.YMapDefaultMarker({
      coordinates: [37.830338, 55.70772],
      title: "Рязанский проспект, д&nbsp;86&nbsp;/ 1, стр.&nbsp;3, эт.&nbsp;3, пом. IV, ком.&nbsp;10",
      color: "tulip",
      size: "normal",
      iconName: "fallback"
    }));
...
new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".examples__slider", {
  slidesPerView: 3,
  spaceBetween: 30,
  navigation: {
...
/* harmony import */ var corner_smoothing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! corner-smoothing */ "./node_modules/corner-smoothing/dist/esm/index.js");
...
document.querySelectorAll(".corner-smooth-50").forEach(el => {
  (0,corner_smoothing__WEBPACK_IMPORTED_MODULE_2__.renderSquircle)(el, {
    cornerRadius: 50
  });
});
__webpack_async_result__();
